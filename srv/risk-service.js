...
module.exports = cds.service.impl(async function () { 
    ...
    */ 
   //The event after is triggered after a READ is carried out for our Risks entity
...
this.on("READ", Risks, async (req, next) => { 
    ...
    const expandIndex = req.query.SELECT.columns.findIndex(
        ...
        column.ref.find((ref) => ref == "bp_BusinessPartner") ) ) { req.query.SELECT.columns.push({ ref: ["bp_BusinessPartner"] }); } 
